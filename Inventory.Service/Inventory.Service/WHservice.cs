...
namespace Inventory.Service
{
    public class WHservice
    {
        ...
        {
            return WarehouseRepository.WHaddressinsert(WH_Name,WH_ShortName,contactperson,jobposition, phone, mobile, Email,Note, bill_street, bill_city, bill_state, bill_postalcode, bill_country, ship_street, ship_city, ship_state, ship_postalcode, ship_country);
        }
    }
}
